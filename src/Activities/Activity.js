  ...
  return (
    <div>
      ...
      <section className="trustees">
        ...
        <h2>
          Our Humanitarian aid is a means the Ezeagu Igbudu Association Toronto
          Canada gives back to our Ezeagu Communities in Nigeria, to promote
          growth and advancement of our people. Our main focus are towards
          Empowerments in the category of; the less privileged people that are
          in dire condition. Our relieve package is to help them find their
          footing in the society as we understand the Challenges/ Situations our
          people face on a daily basis.
        </h2>
        <br />
        <h2 style={{ color: "rgb(114, 48, 23)" }}>FUNDING</h2>
        <h2>
          The source of our humanitarian project funding at this stage are from
          our honorable members of the association. We hope and look forward to
        ...
        <h2>
          In 2018, we were able to visit six Communities in Ezeagu. We provided
          a Relief funds that will help them start up a business, support their
          businesses.etc. We were extremely overjoyed to put smiles in their
          faces and it became a motivator to us knowing that our people needs
          us.
          <br />
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={12} md={4} className="vid-cont">
              <iframe
                ...
                width="560"
                height="315"
                src="https://www.youtube.com/embed/w6V0bPQZyHQ"
                title="YouTube video player"
                frameborder="0"
            ...
            <Grid item xs={12} sm={12} md={4} className="vid-cont">
              <iframe
                ...
                width="560"
                height="315"
                src="https://www.youtube.com/embed/Z-CxAjAsHhw"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowfullscreen
            ...
            <Grid item xs={12} sm={12} md={4} className="vid-cont">
              <iframe
                ...
                width="560"
                height="315"
                src="https://www.youtube.com/embed/2R5PznUO_mA"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowfullscreen
            ...
            <Grid item xs={12} sm={12} md={4} className="vid-cont">
              <iframe
                ...
                width="560"
                height="315"
                src="https://www.youtube.com/embed/Fobbra1PStE"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowfullscreen
